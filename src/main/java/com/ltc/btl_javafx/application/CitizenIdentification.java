...
public class CitizenIdentification {
    ...
    private static volatile CitizenIdentification instance;

    public static CitizenIdentification getInstance() {
        if (instance == null) {
            Class var0 = CitizenIdentification.class;
            synchronized (CitizenIdentification.class) {
                if (instance == null) {
                    instance = new CitizenIdentification();
                }
            }
        }
    ...
    public boolean checkBirthOfDateAndGender(String cccd, int yearOfBirth, String gender) {
